...
public class PermissionDialog extends BasePermissionDialog {
    ...
    public PermissionDialog(Context context, AppOpsService service,
        ...
        setTitle(res.getString(com.android.internal.R.string.app_ops_permission_dialog_title));
        ...
        if(name == null)
            name = mPackageName;
        tv.setText(mContext.getString(com.android.internal.R.string.app_ops_permission_dialog_summary,
